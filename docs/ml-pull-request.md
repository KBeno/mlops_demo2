...
Opening a pull request will trigger a[workflow](../.github/workflows/benedek_mlops_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-1707b521-4968.cloud.databricks.com/explore/data/models/staging/benedek_mlops_demo/benedek_mlops_demo-model)
* [Prod model in UC](https://dbc-1707b521-4968.cloud.databricks.com/explore/data/models/prod/benedek_mlops_demo/benedek_mlops_demo-model)
. 
