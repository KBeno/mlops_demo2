...
git add README.md docs .gitignore benedek_mlops_demo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[benedek_mlops_demo/databricks.yml](../benedek_mlops_demo/databricks.yml) file.
...
Follow the instructions in [benedek_mlops_demo/resources/README.md](../benedek_mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../benedek_mlops_demo/resources/README.md)  to propose, test, and deploy
