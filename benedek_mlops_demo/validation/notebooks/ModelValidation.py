...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``benedek_mlops_demo/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in benedek_mlops_demo/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in benedek_mlops_demo/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-benedek_mlops_demo-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.mlops_demo.benedek_mlops_demo-model", "Full (Three-Level) Model Name")
