...
# ``benedek_mlops_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-benedek_mlops_demo-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_demo.benedek_mlops_demo-model", label="Full (Three-Level) Model Name"
)
